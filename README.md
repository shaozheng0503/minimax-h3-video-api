...
- **语义化参数** — `resolution`（480p/720p/1080p/768p）× `aspect`（16:9/9:16/4:3/1:1）× `duration`（秒），宽高 32 倍数与 17k+5 帧数网格全自动换算
...
# 等价于 width=1088, height=1920, length=243
```
...
> 使用 SDK 时无需查表：传 `resolution="720p", aspect="4:3"` 即自动展开为 960×736。
